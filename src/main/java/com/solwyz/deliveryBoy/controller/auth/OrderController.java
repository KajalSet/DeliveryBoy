...
public class OrderController {
	...
	public ResponseEntity<ApiResponse<Order>> rejectOrder(@PathVariable Long orderId, @PathVariable Long deliveryBoyId,
	...
	public ResponseEntity<ApiResponse<List<Order>>> getAllOrdersByDeliveryBoy(@PathVariable Long deliveryBoyId) {
		...
		List<Order> orders = orderService.getOrdersByDeliveryBoy(deliveryBoyId);
